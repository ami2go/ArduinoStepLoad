...
void printHelptoSerial (void){
 ...
 // Serial.println(F("| * | example: start 100                                               |"));
  Serial.println(F("|----------------------------------------------------------------------|"));
  ...
  Serial.println(F("| * | example: set -ontime 250 -offtime 300 -nrep 5                    |"));
...
//  Serial.println(F("| * | example: setontime 250 [On time value in range 100 us - 6500 us] |"));
  Serial.println(F("|----------------------------------------------------------------------|"));
 ...
 // Serial.println(F("| * | example: setofftime 500[OFF time value in range 100 us - 6500 us]|"));
  Serial.println(F("|----------------------------------------------------------------------|"));
 ...
 // Serial.println(F("| * | example: setnrep 20 [Nrep value in range 1 - 500  ]              |"));
  Serial.println(F("|----------------------------------------------------------------------|"));
  Serial.println(F("| 6 | status|Returns current generator setting and load voltфge        |"));
  Serial.println(F("| * | type: getstatus                                                  |"));
  Serial.println(F("|----------------------------------------------------------------------|"));
  Serial.println(F("| 7 | Vload |Returns measured voltage on load connector                |"));
  Serial.println(F("| * | type: getvload                                                   |"));
  Serial.println(F("|----------------------------------------------------------------------|"));
